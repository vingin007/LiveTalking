...
if __name__ == '__main__':
    ...
    appasync.router.add_options("/human", preflight_handler)
    appasync.router.add_options("/stop", preflight_handler)
    appasync.router.add_options("/offer", preflight_handler)
